	...
	<div class="main">
		<div class="blog">
			<?php if(is_array($exam)): $i = 0; $__LIST__ = $exam;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$examvo): $mod = ($i % 2 );++$i;?><div class="blog_list">
					...
					<div class="blog_para">
						<p class="para"><a  href="<?php echo U('Home/Index/e');?>?eid=<?php echo ($examvo["eid"]); ?>"><img src="/Public/images/exam_img/<?php echo ($examvo["eimgurl"]); ?>" alt=""></a><?php echo ($examvo["edescription"]); ?></p>
						<?php if(($examvo["passed"]) == $_SESSION['logineduserid']): ?><strong class="text-success">已答过题</strong>|<span>选择题得分:<?php echo ($examvo["select_s"]); ?></span>|<span>其他得分:<?php echo ($examvo["black_s"]); ?></span>|<span>完成时间:<?php echo ($examvo["finish_t"]); ?> second</span>|<span>结束答题时间:<?php echo ($examvo["end_t"]); ?></span>
						<div class="read_more">
							<button class="btn btn-lg" disabled="disabled">谢绝答题</button>
						</div>
						<?php else: ?> <span class="text-danger">未答过题</span>
						<div class="read_more">
							<a class="btn" href="<?php echo U('Home/Index/e');?>?eid=<?php echo ($examvo["eid"]); ?>">开始答题</a>
						</div><?php endif; ?>
