              ...
              <h1>
                ...
                <div class="btn-group">
                  <button data-toggle="dropdown" class="btn btn-inverse btn-xs dropdown-toggle">
                    <?php if(isset($Oneexam)): echo ($Oneexam["etitle"]); ?>&nbsp; &nbsp;时间&nbsp; &nbsp;<?php echo ($Oneexam["estarttime"]); ?>-<?php echo ($Oneexam["eendtime"]); ?>
                      <?php else: ?>
                      如果中断意外退出，请选择相应考卷
                  ...
                  <ul class="dropdown-menu dropdown-inverse">
                    <?php if(is_array($exam)): $i = 0; $__LIST__ = $exam;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <a href="/Dashboard/Vexam/index.html?eid=<?php echo ($vo["eid"]); ?>"><?php echo ($vo["etitle"]); ?></a>
                  ...
                  <div id="user-profile-3" class="user-profile row">
                    <div class="col-sm-offset-1 col-sm-10">
                      <div class="well well-sm">
                        ...
                        &nbsp;
                        <div class="inline middle blue bigger-110"> 粗略查看考卷信息 </div>
                          ...
                          <div class="tab-content profile-edit-tab-content">
                            <div id="edit-password" class="tab-pane in active">
                              <div style="position:relative">
                                <iframe style="width:100%;height:800px;" src="/Home/Index/e.html?eid=<?php echo ($eid); ?>"></iframe>
                              </div>
                            </div>
                          </div>
                        </div>
