                                ...
                                <div class="row">
                                  ...
                                  <div class="col-xs-12 col-sm-8">
                                    <div class="form-group">
                                      <label class="col-sm-4 control-label no-padding-right">交卷时间</label>

                                      <div class="col-sm-8">
                                        <input class="col-xs-12 col-sm-10" type="text" value="<?php echo ($vo["end_t"]); ?>" disabled/>
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <label class="col-sm-4 control-label no-padding-right">过程时间</label>

                                      <div class="col-sm-8">
                                        <input class="col-xs-12 col-sm-10" type="text" value="<?php echo ($vo["finish_t"]); ?>" disabled/>
                                      </div>
                                    </div>
                                    <div class="space-4"></div>

                                    <div class="form-group">
                                      <label class="col-sm-4 control-label no-padding-right">选择题得分</label>

                                      <div class="col-sm-8">
                                        <input class="col-xs-12 col-sm-10" type="text" value="<?php echo ($vo["select_s"]); ?>" disabled/>
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      <p class="text col-sm-offset-1">详细：No.<?php echo ($vo["passed"]); ?></p>
                                    </div>
                                  </div>
                                </div>
                                <div class="space-4"></div>
                                <a class="btn btn-info" href="/Home/Index/e.html?fid=<?php echo ($vo["fid"]); ?>">查看</a>
                                <a class="btn btn-success" href="/Dashboard/Manaexam/e.html?fid=<?php echo ($vo["fid"]); ?>">批改这个</a><?php endforeach; endif; else: echo "" ;endif; ?>
